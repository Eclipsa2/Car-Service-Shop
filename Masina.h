...
private:
    ...
    int manopera;
public:
    /*friend class VehiculBuilder;

    static VehiculBuilder create(string aux)
    {
        return VehiculBuilder{aux};
    }

    static VehiculBuilder create(int aux)
    {
        return VehiculBuilder{aux};
    }*/
    ...
    Masina(string marca, string model, Vehicul* v) : Vehicul(v)
    {
        this->marca = marca;
        this->model = model;
        for(int i = 0; i <= 5; i++)
