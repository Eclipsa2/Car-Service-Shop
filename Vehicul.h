...
public:
    ...
    Vehicul operator<(Vehicul& v1)
    {
        if(this->CaiPutere < v1.getCaiPutere())
            return *this;
        return v1;
    }

    template <class Vehicul> Vehicul comparare(Vehicul v1, Vehicul v2)
    {
        if(v1 < v2)
            return v1;
        else
